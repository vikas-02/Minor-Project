...
def find_motion():
	...
	while True:
		...
		if len(contors) > 5:
			cv2.putText(frm2c, "Motion Detected",(20,20), cv2.FONT_HERSHEY_SIMPLEX,2, (255, 0, 0), 2)
			...
			cv2.putText(frm2c, "No Motion Detected",(20,20), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0),2)
